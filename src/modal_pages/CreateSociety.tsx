...
const CreateSociety = () => {
    return (
        <div  className="place-items-center place-content-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow">
                    <div
                        ...
                        <button type="button" onClick={() => window.location.href = '/society'}
